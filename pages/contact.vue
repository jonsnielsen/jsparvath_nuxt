    ...
    <main>
      ...
      <section class="content contact-content">
        ...
        <p class="transition2" :class="{exit: exitRoute,  exitUp: exitUp, exitDown: exitDown,  enterUp: enterUp, enterDown: enterDown , enter: enterRoute}">
          Drop me a line if you would like to work together, get a coffee or just say hello!
        </p>
        ...
        <div id="connect-group" class="transition4" :class="{exit: exitRoute,  exitUp: exitUp, exitDown: exitDown,  enterUp: enterUp, enterDown: enterDown , enter: enterRoute}">
          ...
          <ul id="connect-item-list">
            ...
            <li>&nbsp;&nbsp;<a class="connect-item" href="https://www.instagram.com/jsparvath/" rel="noopener" target="_blank">Instagram</a></li>
          </ul>
        </div>
